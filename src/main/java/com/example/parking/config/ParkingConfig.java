...
import com.example.parking.interceptors.LoggerInterceptor;
import com.example.parking.interceptors.TokenHandler;
...
public class ParkingConfig implements WebMvcConfigurer {
    ...
    @Autowired
    public ParkingConfig(TokenHandler tokenHandler, LoggerInterceptor loggerInterceptor) {
