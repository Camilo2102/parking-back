...
import co.com.parking.utils.RequestUtil;
import co.com.parking.constants.MessageConstants;
import co.com.parking.constants.RoutesConstants;
...
import static co.com.parking.utils.IdGeneratorUtil.generateUUID;
        ...
        for (Object data : dataList) {
            ...
            if (requireId) {
                if (instance.getId() == null) {
                    instance.setId(IdGeneratorUtil.generateUUID());
                }
            }
            result.add(instance);
        }
